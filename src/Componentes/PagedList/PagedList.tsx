        ...
        <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
            <div className="header">
                <button
                    ...
                    aria-label={showFavorites ? 'Mostrar todas as ações' : 'Mostrar ações favoritas'}
                >
                            ...
                            {(showFavorites ? favorites : shares).slice(0, 6).map((share) => (
                                <div className="col-4 col-sm-6 col-md-4 card-spacing" key={share.id}>
                                    <button
                                        ...
                                        aria-label={`Ir para detalhes da ação ${share.symbol}`}
                                    >
                                        <Share
                                    ...
                                    <button
                                        ...
                                        aria-label={favorites.some((fav) => fav.symbol === share.symbol) ? 'Remover dos favoritos' : 'Adicionar aos favoritos'}
                                    >
